...
export default function Header() {
  return (
    <header className="h-full bg-[#1B1F23] text-white flex items-center justify-between px-12">
      <h1 className="text-4xl font-bold">Smart-Sortr</h1>
      {/* GitHub icon/link */}
      <a
        href="https://github.com/Samuel-O-M/Smart-Sortr"
        target="_blank"
